    ...
    d.Augment({
        ...
        Startup: function() {
            ...
            this.TestSpan = this.Element("span", {
                ...
                className: "MathJax_left_box"
            }], ["span", {
                className: "MathJax_ex_box"
            }], ["span", {
                className: "MathJax_em_box"
            }], ["span", {
                className: "MathJax_right_box"
            }]]);
        ...
        getDefaultExEm: function() {
            ...
            this.defaultWidth = Math.max(0, m.lastChild.offsetLeft - m.firstChild.offsetLeft - 2);
            document.body.removeChild(m)
        },
        preTranslate: function(s) {
            ...
            for (D = 0; D < z; D++) {
                ...
                E.className += " mjx-test-" + (p.HTMLCSS.display ? "display" : "inline");
            ...
            for (D = 0; D < z; D++) {
                ...
                A = Math.max(0, p.HTMLCSS.display ? E.lastChild.offsetWidth - 1 : E.lastChild.offsetLeft - E.firstChild.offsetLeft - 2);
                if (F === 0 || F === "NaN") {
                    B.push(u);
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function() {
        ...
        i.mo.Augment({
            toHTML: function(x) {
                ...
                if (d.isChar(A) && y && y.isa(i.munderover) && d.isChar(this.CoreText(y.data[y.base]))) {
                    var u = y.data[y.over]
                      , w = y.data[y.under];
            ...
            HTMLcanStretch: function(q) {
                ...
                if (o && o.isa(i.munderover) && d.isChar(this.CoreText(o.data[o.base]))) {
                    var p = o.data[o.over]
                      , n = o.data[o.under];
        ...
        i.msubsup.Augment({
            toHTML: function(M, K, F) {
                ...
                if (this.data[this.base] && K == null && F == null && (this.data[this.base].type === "mi" || this.data[this.base].type === "mo")) {
                    if (d.isChar(this.data[this.base].data.join("")) && w[0].scale === 1 && !this.data[this.base].Get("largeop")) {
                        B = A = 0
                    }
                }
    ...
    a.mtable.Augment({
        toHTML: function(r) {
            ...
            var aA = aG(I.columnspacing)
              ...
              , U = [];
            for (ae = 0,
            ac = aA.length; ae < ac; ae++) {
                aA[ae] = b.length2em(aA[ae], aB)
            }
            for (ae = 0,
            ac = aT.length; ae < ac; ae++) {
            ...
            if (I.equalcolumns && I.width !== "auto") {
                if (aM) {
                    ...
                    for (ae = 0,
                    ac = Math.min(ap + 1, aP.length); ae < ac; ae++) {
                        aP[ae] = ab
                    }
                    ab = 0;
                    af = 1;
                    ag = ap + 1;
                    for (ae = 0,
                    ac = Math.min(ap + 1, aA.length); ae < ac; ae++) {
                        ab += aA[ae]
                    }
                } else {
                    ab = b.length2em(I.width, aB);
                    for (ae = 0,
                    ac = Math.min(ap, aA.length); ae < ac; ae++) {
                        ab -= aA[ae]
                    }
                    ab /= ap;
                    for (ae = 0,
        ...
        HTMLhandleSpace: function(d) {
            ...
            if (!this.hasFrame && d.bbox.width == null) {
                d.firstChild.style.marginLeft = d.firstChild.style.marginRight = b.Em(1 / 6);
                d.bbox.w += 1 / 3;
                d.bbox.rw += 1 / 3;
                d.bbox.lw += 1 / 6
            }
